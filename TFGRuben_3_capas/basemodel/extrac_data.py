...
class enetv3(nn.Module):
    def __init__(self, modelname, out_dim=5, freeze_bn=True):
        ...
        self.hook_handle = self.basemodel._blocks[15]._project_conv.register_forward_hook(self.save_activation)
...
with torch.no_grad():
    ...
    np.save(f"/home/ruben/TFGRuben_3_capas/Data/hook/activations/feature_activations{args.split_part}.npy", feature_activations_array)
