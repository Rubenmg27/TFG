...
def reliability_diagram(predictions, y_test,threshold = None, num_groups=10):
...
def bayesian_predictions_torch(model, X_test, samples=100, batch_size=64):
    """Generates bayesian predictions
    ...
    with torch.no_grad():
        for i in range(samples):
            ...
            for start in range(0, total_samples, batch_size):
                ...
                batch_preds.append(interpolate_results_tensor.cpu().numpy())
