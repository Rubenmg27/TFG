...
def load_top_k_least_uncertain_samples(csv_path,  y, names, k=750, num_classes=6):
    """
    ...
    #print(thresholds)
    thresholds = {0: np.float64(0.6), 4: np.float64(0.6), 1: np.float64(0.6), 
        3: np.float64(0.6), 5: np.float64(0.6), 2: np.float64(0.6)}
    indices = filtrar_muestras_por_threshold(
         y, names, uncertainty_map, thresholds)
...
def filtrar_muestras_por_threshold( y, names, uncertainty_map, thresholds):
    filtered_indices = []
